            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.update', $user->id) }}">
                        ...
                        <div class="form-group row">
                            <label for="catering" class="col-md-4 col-form-label text-md-right">{{ __('Catering Company') }}</label>

                            <div class="col-md-6">
                                <input id="catering" type="text" class="form-control @error('catering') is-invalid @enderror" name="catering" value="{{ $user->catering }}" autocomplete="catering">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="contactno" type="text" class="form-control @error('contactno') is-invalid @enderror" name="contactno" value="{{ $user->contactno }}" required autocomplete="contactno">
                        ...
                        <div class="form-group row">
                            <label for="campuses" class="col-md-4 col-form-label text-md-right">{{ __('Campuses') }}</label>
                        
                            <div class="col-md-6">
                                <input id="campuses" type="text" class="form-control @error('campuses') is-invalid @enderror" name="campuses" value="{{ $user->campuses }}" autocomplete="campuses">
