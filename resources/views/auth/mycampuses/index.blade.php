...
<div class="row">
    <div class="col-lg-7">
        <div class="card card-small">
            ...
            <div class="card-body">
                <span class="font-weight-regular mb-4 d-inline-block">Welcome!🌞 Below is a list of campuses you cater to. Click Manage to manage menu, food, and categories for that campus.</span> 
