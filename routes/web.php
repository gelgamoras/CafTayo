...
//Subscribers
Route::get('subscribers/list', 'SubscribersController@index')->name('subscribers.index'); 
Route::get('subscribers/create', 'SubscribersController@create')->name('subscribers.create'); 
Route::post('subscribers/create', 'SubscribersController@store')->name('subscribers.store'); 
>>>>>>> Stashed changes
